...
public class MMConfigSpawnEntry {
	...
	public static void setupCategoryDescriptions(Configuration config)
	{
		...
		config.addCustomCategoryComment(category12, "Blocks or BlockStates this mob can spawn on; for a list of all different blockstates present, check the multimob config folder. This is NOT checked if the regular spawn checks are not overriden.");
