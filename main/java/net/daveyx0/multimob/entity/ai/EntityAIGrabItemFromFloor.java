...
public class EntityAIGrabItemFromFloor extends EntityAIBase {
    ...
    public boolean shouldExecute()
    {
        ...
        java.util.List<Entity> list = this.temptedEntity.getEntityWorld().getEntitiesWithinAABBExcludingEntity(temptedEntity, temptedEntity.getEntityBoundingBox().grow(10f, 10f, 10f));
