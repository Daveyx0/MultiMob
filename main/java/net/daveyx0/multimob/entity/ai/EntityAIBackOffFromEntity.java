...
public class EntityAIBackOffFromEntity extends EntityAIBase {
	...
	public EntityAIBackOffFromEntity(EntityCreature entitycreature , double maxDistance, boolean defensiveAttack) 
	{
	...
	*/
	public boolean shouldExecute()
	{
        ...
        {
        	if(this.creature.getDistance(target) <= this.maxDistance && this.creature.canEntityBeSeen(target))
        	{
        		return true;
        	}
	...
	*/
    ...
    public void updateTask()
    {
    	if(target != null)
    	{
            ...
            double d = -0.69999999999999996D / (this.creature.motionX * this.creature.motionX + this.creature.motionZ * this.creature.motionZ + 0.0625D) * 1.5;
            this.creature.motionX *= d;
            this.creature.motionZ *= d;
            
            if(creature.collidedHorizontally)
            {
