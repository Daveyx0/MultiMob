...
public abstract class EntityAICustomTarget extends EntityAIBase
{
    ...
    public EntityAICustomTarget(EntityLiving creature, boolean checkSight)
    {
        this(creature, checkSight, false);
    }

    public EntityAICustomTarget(EntityLiving creature, boolean checkSight, boolean onlyNearby)
    {
