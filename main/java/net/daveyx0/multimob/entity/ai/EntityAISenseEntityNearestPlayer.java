...
public class EntityAISenseEntityNearestPlayer extends EntityAIBase
{
    ...
    public EntityAISenseEntityNearestPlayer(EntityLiving entityLivingIn, int range)
    {
        ...
        this.predicate = new Predicate<Entity>()
        {
            public boolean apply(@Nullable Entity p_apply_1_)
            {
                ...
                else
                {
                    ...
                    return (double)p_apply_1_.getDistance(EntityAISenseEntityNearestPlayer.this.entityLiving) > d0 ? false : EntityAITarget.isSuitableTarget(EntityAISenseEntityNearestPlayer.this.entityLiving, (EntityLivingBase)p_apply_1_, false, false);
                }
            }
        };
