...
public class EntityAICustomFollowOwner extends EntityAIBase
{
    ...
    public EntityAICustomFollowOwner(EntityPrimitiveTameableMob tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
